<%@ Page Title="" Debug="true" Language="C#" MasterPageFile="~/Employee/Employee.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Employee_Default" %>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center align-items-center">
                <div class="col-12 col-lg-12 col-xl-12">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-12">
                            <div class="card border-primary border-1 shadow  p-0">
                                <div class="card-header text-white fs-5" style="background-color: darkturquoise;">
                                    My Dashboard &nbsp; &nbsp; &nbsp;
                                ...
                                <div class="card-body  mt-3">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <asp:Calendar ID="Calendar1" CssClass="w-100 h-100" runat="server" BackColor="White" BorderColor="#3366CC" BorderWidth="1px" CellPadding="1" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="12pt" ForeColor="#003399" Height="200px" Width="220px">
                                                <DayHeaderStyle BackColor="#99CCCC" CssClass="text-center" ForeColor="#336666" Height="1px" />
                                                <NextPrevStyle Font-Size="11pt" ForeColor="#CCCCFF" />
                                                <OtherMonthDayStyle ForeColor="#999999" />
                                                <SelectedDayStyle BackColor="#FF6969" Font-Bold="True" ForeColor="#ffffff" />
                                                <SelectorStyle BackColor="#FF6969" ForeColor="#336666" />
                                                <TitleStyle BackColor="#003399" BorderColor="#3366CC" BorderWidth="3px" Font-Bold="True" Font-Size="10pt" ForeColor="#CCCCFF" Height="25px" />
                                                <TodayDayStyle BackColor="#FF6969" ForeColor="White" />
                                        ...
                                        <div class="col-lg-6">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="card info-card sales-card border border-warning">
                                                        ...
                                                        <div class="card-body">
                                                            <h5 class="card-title">Total Job Report Count </h5>
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="ps-3 ms-auto w-100 ">
                                                                    <h6 class="mx-auto w-100">
                                                                        <asp:Label ID="lblTotalJObCount" CssClass="h1 text-danger" runat="server" Text="Label"></asp:Label></h6>
                                                                    <%--  <span class="text-success small pt-1 fw-bold">12%</span> <span class="text-muted small pt-2 ps-1">increase</span>--%>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card info-card sales-card border border-primary">
                                                        ...
                                                        <div class="card-body">
                                                            <h5 class="card-title">Job Count <span class="text-muted fw-bolder ms-2">
                                                                <asp:Label ID="lblDateToday" runat="server" Text="Label"></asp:Label></span> </h5>

                                                            <div class="d-flex align-items-center">
                                                                <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                                                                    <i class="fa-regular fa-clipboard fa-2xl" style="color: #575757;"></i>
                                                                </div>
                                                                <div class="ps-3">
                                                                    <h6>
                                                                        <asp:Label ID="lblJobCountToday" CssClass="h1 text-danger " runat="server" Text="Label"></asp:Label></h6>
                                                                    <%--  <span class="text-success small pt-1 fw-bold">12%</span> <span class="text-muted small pt-2 ps-1">increase</span>--%>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="card info-card sales-card border border-info">



                                                        <div class="card-body">
                                                            <h5 class="card-title">My Current Rating</h5>

                                                            <div class="d-flex align-items-center">
                                                                <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                                                                    <i class="fa-regular fa-star fa-2xl" style="color: #575757;"></i>
                                                                </div>
                                                                <div class="ps-3">
                                                                    <h6>
                                                                        <asp:Label ID="lblRating" CssClass="h1  text-primary" runat="server" Text="Label"></asp:Label></h6>
                                                                    <%--  <span class="text-success small pt-1 fw-bold">12%</span> <span class="text-muted small pt-2 ps-1">increase</span>--%>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <asp:LinkButton ID="btnVieLeave" OnClick="btnVieLeave_Click" CssClass="card info-card sales-card border border-warning" runat="server">

                                                        <div class="card-body">
                                                            <h5 class="card-title">View Leave Appl Status </h5>
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="ps-3">
                                                                    <h6>
                                                                        <asp:Label ID="lblLeaveApplication" CssClass="h1 text-success" runat="server" Text="Label"></asp:Label></h6>
                                                                    <%--  <span class="text-success small pt-1 fw-bold">12%</span> <span class="text-muted small pt-2 ps-1">increase</span>--%>
                                                                </div>
                                                            </div>
                                                        </div>
                    ...
                    <asp:Panel ID="pnlViewLeave" Visible="false" runat="server">
                        <div class="row">
                            <div class="card">
                                <div class="card-header text-white fw-bolder" style="background-color:turquoise;">

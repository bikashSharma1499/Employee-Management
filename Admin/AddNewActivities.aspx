<%@ Page Title="" Language="C#" EnableEventValidation="false" EnableViewState="true" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="AddNewActivities.aspx.cs" Inherits="Admin_Default2" %>
    ...
    <main id="main" class="main " style="margin-bottom: 450px;">
        ...
        <section class="section dashboard">
            ...
            <div class="card mx-auto p-3 shadow border-primary" style="border:2px solid; ">
                <div class="card-header text-white fw-bolder" style="background-color:turquoise;">Add New Activity</div>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body p-2">
                                    ...
                                    <asp:DropDownList ID="DropDownProjectName"  DataValueField="Puid" DataTextField="ProjectName" AppendDataBoundItems="true" CssClass="form-control" runat="server">

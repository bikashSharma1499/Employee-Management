<%@ Page Title="" Language="C#" EnableEventValidation="false" EnableViewState="true" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="AddNewFunction.aspx.cs" Inherits="Admin_Default2" %>
    ...
    <main id="main" class="main " style="margin-bottom: 450px;">
        ...
        <section class="section dashboard">
            ...
            <div class="card mx-auto p-3 shadow border-primary" style="border:2px solid; ">
                <div class="card-header text-white fw-bolder" style="background-color:turquoise;">Add New Function</div>
                <div class="row  border-4 rounded-3">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-2">
                                <div class="form-floating">
                                    ...
                                    <label>
                                        Function Name<asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="Error" Display="Dynamic" ControlToValidate="txtProject" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
                                    </label>
                                </div>
                                <div class="mt-3">
                    ...
                    <div class="col-lg-12 form-group">
                        ...
                        <div class="table-responsive rounded-2">
                            ...
                            <asp:GridView ID="gvProject" ShowHeaderWhenEmpty="true" EmptyDataText="No Data Found..." runat="server" DataKeyNames="Fuid" AutoGenerateColumns="False" AllowPaging="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Functionn" HeaderText="Function Name"  SortExpression="ProjectName" NullDisplayText="N/A" ReadOnly="false">

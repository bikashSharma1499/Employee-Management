<%@ Page Title="" Language="C#" EnableEventValidation="false" EnableViewState="true" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="AddNewPIA.aspx.cs" Inherits="Admin_Default2" %>
    ...
    <main id="main" class="main " style="margin-bottom: 450px;">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add New PIA / Agency</li>
        ...
        <section class="section dashboard">
            ...
            <div class="card mx-auto p-3 shadow border-primary" style="border:2px solid; ">
                <div class="card-header text-white fw-bolder" style="background-color:turquoise;">Add New PIA / Agency</div>
                <div class="row  border-4 rounded-3">
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body p-2">
                                    ...
                                    <asp:DropDownList ID="DropDownFunctionName"  DataValueField="Fuid" DataTextField="ProjectName" AppendDataBoundItems="true" CssClass="form-control" runat="server">
                                        <asp:ListItem Value="0">Select</asp:ListItem>

                                    </asp:DropDownList>
                                    <label>
                                        Function
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="Error" InitialValue="0" ControlToValidate="DropDownProjectName" runat="server" Display="Dynamic" ErrorMessage="*"></asp:RequiredFieldValidator>
                                    </label>
                                ...
                                <div class="form-floating">
                                    ...
                                    <label>
                                        Activity Name<asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="Error" Display="Dynamic" ControlToValidate="txtProject" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
                                    </label>
                                </div>
                                <div class="mt-3">
                    ...
                    <div class="col-lg-12 form-group">
                        ...
                        <div class="table-responsive rounded-2">
                            ...
                            <asp:GridView ID="gvProject" ShowHeaderWhenEmpty="true" EmptyDataText="No Data Found..." runat="server" DataKeyNames="ActId" AutoGenerateColumns="False" AllowPaging="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Activities" HeaderText="Activity"  SortExpression="Activities" NullDisplayText="N/A" ReadOnly="false">
                                        <HeaderStyle ForeColor="White" Wrap="false" BackColor="#241468" Font-Bold="true" Font-Size="Smaller" />
                                        <ItemStyle Font-Size="Smaller" Wrap="false" />
                                    </asp:BoundField>
